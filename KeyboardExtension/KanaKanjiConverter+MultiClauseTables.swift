...
extension KanaKanjiConverter {
    ...
    // 体言直後のかなコピュラ・クラスタ(だし/だから/だけど…。2773): 体言+だ は最も基本的な述定で、
    ...
    // 楽器名(2773): 直後の 弾く 系(弾ける/弾いて/弾く…)を同音の 引く/曳く 系より優遇する。
    ...
    // たいして: 同じ構図(かな副詞クランプで最良、seed {たいして, 大して, 対して} の順に変種を出す。2772)
    ...
    static let multiClauseKanaAdverbReadings: Set<String> = [
        ...
        // かな たいして(7772)を跨ぎ たいしてうまくない→対してうまくない だった(ユーザ指定 2772)
        "たいして",
