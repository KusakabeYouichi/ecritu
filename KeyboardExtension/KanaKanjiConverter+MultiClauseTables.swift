...
extension KanaKanjiConverter {
    ...
    // 下線(6940)は 河川 5321/架線 6054/歌仙 6571/寡占 6722/貸せん(派生 7200)に囲まれる(LM 未収録の 化繊/加線 は 8700 で届かない)。下線 を持ち上げる方式は
    // 耳下腺(収穫床 8700)が 時+下線 に割れる(河川 に勝つ幅 1619 と両立しない)ので、同音語側を全部下げる
    static let multiClauseHomophoneDemotionsByReading: [String: [String: Int]] = [
        "かんりょう": ["官僚": 800],
        "かせん": ["河川": 2000, "架線": 2000, "歌仙": 2000, "寡占": 2000, "貸せ": 2000],
        "こしょう": ["呼称": 1200],
        "たいき": ["大気": 1200],
        "たいひ": ["対比": 1000],
        "じんめい": ["人命": 600]
