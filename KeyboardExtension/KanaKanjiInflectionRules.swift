...
extension KanaKanjiConverter {
    ...
    static let adjectiveInflectionRules: [InflectionRule] = [
        ...
        InflectionRule(readingSuffix: "そー", baseReadingSuffix: "い", allowedClasses: [InflectionClass.adjectiveI]),
        InflectionRule(readingSuffix: "そーだ", baseReadingSuffix: "い", allowedClasses: [InflectionClass.adjectiveI]),
        InflectionRule(readingSuffix: "そーな", baseReadingSuffix: "い", allowedClasses: [InflectionClass.adjectiveI]),
        InflectionRule(readingSuffix: "そーに", baseReadingSuffix: "い", allowedClasses: [InflectionClass.adjectiveI]),
        InflectionRule(readingSuffix: "そーで", baseReadingSuffix: "い", allowedClasses: [InflectionClass.adjectiveI]),
        ...
        InflectionRule(readingSuffix: "そー", baseReadingSuffix: "", allowedClasses: [InflectionClass.adjectiveI]),
        InflectionRule(readingSuffix: "そーだ", baseReadingSuffix: "", allowedClasses: [InflectionClass.adjectiveI]),
        InflectionRule(readingSuffix: "そーな", baseReadingSuffix: "", allowedClasses: [InflectionClass.adjectiveI]),
        InflectionRule(readingSuffix: "そーです", baseReadingSuffix: "", allowedClasses: [InflectionClass.adjectiveI]),
    ...
    static let ichidanInflectionRules: [InflectionRule] = [
        ...
        InflectionRule(readingSuffix: "なくなります", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        InflectionRule(readingSuffix: "なくなりました", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        InflectionRule(readingSuffix: "なくなりません", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        InflectionRule(readingSuffix: "なくなりませんでした", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        InflectionRule(readingSuffix: "なくなれば", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        InflectionRule(readingSuffix: "なくなり", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        ...
        InflectionRule(readingSuffix: "ながら", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        ...
        InflectionRule(readingSuffix: "そー", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        InflectionRule(readingSuffix: "そーだ", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        InflectionRule(readingSuffix: "そーな", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        InflectionRule(readingSuffix: "そーに", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        InflectionRule(readingSuffix: "そーで", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        ...
        InflectionRule(readingSuffix: "てきちゃう", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        InflectionRule(readingSuffix: "てきちゃった", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        InflectionRule(readingSuffix: "てきちゃって", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        ...
        InflectionRule(readingSuffix: "とけば", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        ...
        InflectionRule(readingSuffix: "ちゃおう", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        ...
        InflectionRule(readingSuffix: "られてきて", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        InflectionRule(readingSuffix: "られてきます", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        InflectionRule(readingSuffix: "られてきました", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        // 受身+たい 願望連鎖(見られたくない/食べられたかった 等)。プレーン語幹の たい 系
        // (readingSuffix: たくない)はあるが受身を挟む形が未定義で、おくられたくないね→
        // 置く+られたくない(かな断片合成)等に全長を取られる。
        InflectionRule(readingSuffix: "られたい", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        InflectionRule(readingSuffix: "られたく", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        InflectionRule(readingSuffix: "られたくない", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        InflectionRule(readingSuffix: "られたくなくて", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        InflectionRule(readingSuffix: "られたくなかった", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        InflectionRule(readingSuffix: "られたかった", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
        InflectionRule(readingSuffix: "られたければ", baseReadingSuffix: "る", allowedClasses: [InflectionClass.ichidan]),
    ...
    static let suruInflectionRules: [InflectionRule] = [
        ...
        InflectionRule(readingSuffix: "しなくなります", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
        InflectionRule(readingSuffix: "しなくなりました", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
        InflectionRule(readingSuffix: "しなくなりません", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
        ...
        InflectionRule(readingSuffix: "しながら", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
        ...
        InflectionRule(readingSuffix: "しそー", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
        InflectionRule(readingSuffix: "しそーだ", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
        InflectionRule(readingSuffix: "しそーな", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
        InflectionRule(readingSuffix: "しそーに", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
        InflectionRule(readingSuffix: "しそーで", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
        ...
        InflectionRule(readingSuffix: "しとけば", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
        ...
        InflectionRule(readingSuffix: "しちゃおう", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
        ...
        InflectionRule(readingSuffix: "されちゃう", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
        InflectionRule(readingSuffix: "されちゃった", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
        InflectionRule(readingSuffix: "されちゃって", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
        // 受身+てくる アスペクト連鎖(送信されてくる/されてきます 等)。
        InflectionRule(readingSuffix: "されてくる", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
        InflectionRule(readingSuffix: "されてきた", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
        InflectionRule(readingSuffix: "されてきて", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
        InflectionRule(readingSuffix: "されてきます", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
        InflectionRule(readingSuffix: "されてきました", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
        // 受身+たい 願望連鎖(送信されたくない/注目されたかった 等)。
        InflectionRule(readingSuffix: "されたい", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
        InflectionRule(readingSuffix: "されたく", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
        InflectionRule(readingSuffix: "されたくない", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
        InflectionRule(readingSuffix: "されたくなくて", baseReadingSuffix: "する", allowedClasses: [InflectionClass.suru]),
    ...
    static let sahenNounSuruInflectionRules: [InflectionRule] = [
        ...
        InflectionRule(readingSuffix: "できちゃう", baseReadingSuffix: "", baseCandidateSuffixes: [""], allowedClasses: [InflectionClass.suru]),
        InflectionRule(readingSuffix: "できちゃった", baseReadingSuffix: "", baseCandidateSuffixes: [""], allowedClasses: [InflectionClass.suru]),
        ...
        InflectionRule(readingSuffix: "しながら", baseReadingSuffix: "", baseCandidateSuffixes: [""], allowedClasses: [InflectionClass.suru]),
        ...
        InflectionRule(readingSuffix: "しとけば", baseReadingSuffix: "", baseCandidateSuffixes: [""], allowedClasses: [InflectionClass.suru]),
        ...
        InflectionRule(readingSuffix: "しちゃおう", baseReadingSuffix: "", baseCandidateSuffixes: [""], allowedClasses: [InflectionClass.suru]),
        ...
        InflectionRule(readingSuffix: "されちゃう", baseReadingSuffix: "", baseCandidateSuffixes: [""], allowedClasses: [InflectionClass.suru]),
        InflectionRule(readingSuffix: "されちゃった", baseReadingSuffix: "", baseCandidateSuffixes: [""], allowedClasses: [InflectionClass.suru]),
        InflectionRule(readingSuffix: "されちゃって", baseReadingSuffix: "", baseCandidateSuffixes: [""], allowedClasses: [InflectionClass.suru]),
