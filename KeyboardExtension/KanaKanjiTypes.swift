...
extension KanaKanjiConverter {
    ...
    static let postfixPassthroughSuffixes: [String] = [
        "ほうがいい", "ほうがよい", "ほうが", "ようになる", "ようにする", "ようにして", "ように", "よう", "ような", "ようだ", "ようです", "みたいでした", "みたいだった", "みたいです", "みたいだ", "みたいな", "みたいに", "みたい", "はずがない", "はずだった", "はずでした", "はずです", "はずだ", "はず", "です", "んですけれど", "んですけど", "んだけれど", "んだけど", "のだ", "んです", "んだ", "だろう", "だったら", "だった", "なければ", "なくても", "なくなりました", "なくなりません", "なくなります", "なくなりたい", "なくならなかった", "なくならない", "なくなった", "なくなって", "なくなれば", "なくなろう", "なくなり", "なくなる", "なくて", "なかった", "なく", "ない", "だ", "けれど", "けど", "ください", "だけだ", "こと", "など", "だけ", "では", "には", "とは", "よりも", "より", "まで", "なら", "から", "へ", "は", "を", "に", "で", "と", "が", "も", "の", "し", "ね", "よ", "な", "か", "や", "ぞ", "ぜ", "さ"
    ]
