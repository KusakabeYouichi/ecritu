...
extension KanaKanjiConverter {
    ...
    static let postfixPassthroughSuffixes: [String] = [
        "ほうがいい", "ほうがよい", "ほうが", "ようになる", "ようにする", "ようにして", "ように", "ような", "ようだ", "ようです", "んですけれど", "んですけど", "んだけれど", "んだけど", "のだ", "んです", "んだ", "けれど", "けど", "ください", "だけだ", "こと", "など", "だけ", "では", "には", "とは", "まで", "なら", "から", "へ", "は", "を", "に", "で", "と", "が", "も", "の", "し", "ね", "よ", "な", "か", "や", "ぞ", "ぜ", "さ"
    ]
