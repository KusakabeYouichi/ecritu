...
extension KanaKanjiConverter {
    ...
    static let inflectionRankingSuffixes: [String] = [
        ...
        "んです", "んだ",
        "くない", "かったり", "かった", "ければ", "くれば", "くなり", "やすい", "やすく", "よう", "こよう", "こい", "たがらない", "たがります", "がらない", "たい", "れば", "ねば", "ず",
        "がり",
    ...
    static let postfixPassthroughSuffixes: [String] = [
        "ほうがいい", "ほうがよい", "ほうが", "ようになる", "ようにする", "ようにして", "ように", "よう", "ような", "ようだ", "ようです", "んですけれど", "んですけど", "んだけれど", "んだけど", "のだ", "んです", "んだ", "だったら", "だった", "なければ", "なく", "ない", "だ", "けれど", "けど", "ください", "だけだ", "こと", "など", "だけ", "では", "には", "とは", "まで", "なら", "から", "へ", "は", "を", "に", "で", "と", "が", "も", "の", "し", "ね", "よ", "な", "か", "や", "ぞ", "ぜ", "さ"
    ]
