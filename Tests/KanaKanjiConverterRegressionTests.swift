...
final class KanaKanjiConverterRegressionTests: XCTestCase {
    ...
    // LM順乖離スイープの残渣一括是正(ユーザ承認117+33読み、2548/2549)の固定。
    ...
    func testRegressionRealLMSweepApprovedResiduePairs() throws {
        ...
        let pairs: [(String, String)] = [
            ...
            ("くどく", "功徳"), ("くにお", "邦男"), ("くるめ", "久留米"), ("こうが", "黄河"), ("こうき", "後期"),
            ("こうず", "構図"), ("こうない", "構内"), ("こうやま", "神山"), ("こうよう", "高揚"), ("こうり", "公理"),
            ("こし", "腰"), ("こた", "古田"), ("こな", "粉"), ("こもだ", "米田"), ("さい", "再"), ("さけ", "酒"),
            ("さし", "指し"), ("さつ", "冊"), ("さとこ", "敏子"), ("さわだ", "沢田"), ("しこう", "施行"), ("しだ", "志田"),
            ("しゅういち", "修一"), ("しゅん", "駿"), ("しるべ", "導"), ("しんし", "紳士"), ("しんど", "震度"),
            ("じゅり", "受理"), ("じょうおう", "承応"), ("すおう", "周防"), ("せい", "性"), ("せんない", "線内"),
            ("そうけい", "総計"), ("そうだ", "操舵"), ("そだ", "曽田"), ("たい", "対"), ("たいぞう", "泰三"),
            ("たいない", "体内"), ("たかあき", "貴明"), ("たかこ", "貴子"), ("たから", "宝"), ("たくろう", "拓郎"),
            ("たけもと", "竹本"), ("たける", "健"), ("ただお", "忠夫"), ("だいだ", "代打"), ("ちょうだ", "町田"),
            ("つげ", "告げ"), ("つむ", "積む"), ("つよし", "剛"), ("つる", "鶴"), ("とう", "等"), ("としろう", "俊郎"),
            ("なおや", "直也"), ("なおゆき", "尚之"), ("なおよし", "直美"), ("なかみ", "中身"), ("のせ", "乗せ"),
            ("のぶお", "信雄"), ("のぶただ", "信忠"), ("のぶゆき", "信之"), ("はえ", "栄え"), ("はた", "羽田"),
            ("はたの", "波多野"), ("はる", "春"), ("はるお", "春夫"), ("はるだ", "原田"), ("ひだ", "飛騨"), ("ひでお", "英夫"),
            ("ひでこ", "秀子"), ("ひろう", "披露"), ("ふくそう", "服装"), ("ふくよう", "服用"), ("ふこう", "不幸"),
            ("ふみひろ", "史浩"), ("へき", "碧"), ("ほうろう", "放浪"), ("ほや", "ホヤ"), ("まいる", "マイル"),
            ("まおう", "魔王"), ("まさあき", "正昭"), ("まさこ", "雅子"), ("まさつぐ", "正次"), ("まさなり", "雅也"),
            ("まさのぶ", "正信"), ("まちこ", "町子"), ("まり", "マリ"), ("みえ", "見え"), ("みかえる", "ミカエル"),
            ("みたて", "見立て"), ("みつお", "光雄"), ("もくし", "目視"), ("もとむ", "探"), ("もん", "門"), ("やすこ", "靖子"),
            ("ゆうや", "裕也"), ("ゆき", "雪"), ("よしさだ", "義貞"), ("よしただ", "義理"), ("よしだ", "吉田"),
            ("よしひと", "賢人"), ("よしみつ", "義満"), ("よそう", "予想"), ("りょうこ", "良子")
        ]
        var failures: [String] = []
