...
2. Run:
   - `python tools/build_sudachi_index.py --input-glob "<SUDACHI_CSV_GLOB>" --output tmp/ÉcrituPremierVocab.json --max-candidates 8 --min-reading-len 1 --max-reading-len 10 --max-candidate-len 20 --single-reading-max-candidates 21 --single-reading-max-candidate-len 1`
